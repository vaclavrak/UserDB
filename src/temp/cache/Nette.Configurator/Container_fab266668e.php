...
class Container_fab266668e extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Symfony\Component\Console\Command\Command' => [['migrations.continueCommand', 'migrations.createCommand', 'migrations.resetCommand']],
			...
			'App\Model\cc' => [1 => ['cc']],
			'App\RouterFactory' => [1 => ['61_App_RouterFactory']],
		...
		'services' => [
			'61_App_RouterFactory' => 'App\RouterFactory',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'env' => [
				...
				'USERDB_DB_1_PORT' => 'tcp://172.17.0.2:3306',
				'USERDB_DB_1_ENV_GPG_KEYS' => '177F4010FE56CA3336300305F1656F24C74CD1D8',
				'DB_1_PORT_3306_TCP_PORT' => '3306',
				'LANG' => 'C',
				'USERDB_DB_1_PORT_3306_TCP' => 'tcp://172.17.0.2:3306',
				'HOSTNAME' => '6abce9f5942b',
				...
				'USERDB_DB_1_PORT_3306_TCP_PROTO' => 'tcp',
				...
				'DB_1_PORT_3306_TCP' => 'tcp://172.17.0.2:3306',
				'DB_1_PORT_3306_TCP_ADDR' => '172.17.0.2',
				'PHP_EXTRA_BUILD_DEPS' => 'apache2-dev',
				'USERDB_DB_1_PORT_3306_TCP_ADDR' => '172.17.0.2',
				'DB_PORT_3306_TCP_PORT' => '3306',
				'USERDB_DB_1_NAME' => '/userdb_web_1/userdb_db_1',
				'PWD' => '/opt/userdb',
				'USERDB_DB_1_ENV_GOSU_VERSION' => '1.12',
				'USERDB_SALT' => 'saltvalue',
				'DB_ENV_MYSQL_ROOT_PASSWORD' => 'rootpwd654',
				'PHP_LDFLAGS' => '-Wl,-O1 -pie',
				'DB_1_ENV_MYSQL_DATABASE' => 'userdb',
				...
				'DB_1_ENV_MARIADB_MAJOR' => '10.1',
				'USERDB_DB_1_ENV_MYSQL_ROOT_PASSWORD' => 'rootpwd654',
				'USERDB_DB_1_ENV_MYSQL_DATABASE' => 'userdb',
				'DB_1_ENV_MARIADB_VERSION' => '1:10.1.48+maria-1~bionic',
				'DB_ENV_MARIADB_VERSION' => '1:10.1.48+maria-1~bionic',
				'DB_1_ENV_GPG_KEYS' => '177F4010FE56CA3336300305F1656F24C74CD1D8',
				'DB_ENV_GPG_KEYS' => '177F4010FE56CA3336300305F1656F24C74CD1D8',
				'DB_ENV_MARIADB_MAJOR' => '10.1',
				'DB_ENV_MYSQL_DATABASE' => 'userdb',
				'PHP_VERSION' => '7.2.34',
				'APACHE_PID_FILE' => '/var/run/apache2/apache2.pid',
				'TRACY_ENABLE' => '1',
				'DB_1_ENV_MYSQL_ROOT_PASSWORD' => 'rootpwd654',
				'SHLVL' => '0',
				'INFLUX_URL' => 'influxdb://wewimo:xxx@10.107.252.101:8086/wewimo',
				'DB_NAME' => '/userdb_web_1/db',
				'DB_1_NAME' => '/userdb_web_1/db_1',
				'DB_1_ENV_GOSU_VERSION' => '1.12',
				'USERDB_DB_1_ENV_MARIADB_MAJOR' => '10.1',
				'DB_1_PORT' => 'tcp://172.17.0.2:3306',
				'PATH' => '/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin',
				'PHP_SHA256' => '409e11bc6a2c18707dfc44bc61c820ddfd81e17481470f3405ee7822d8379903',
				'USERDB_IDS_PASSWORD' => 'xxx',
				'USERDB_DB_1_PORT_3306_TCP_PORT' => '3306',
				'DB_ENV_GOSU_VERSION' => '1.12',
				'USERDB_DB_USERNAME' => 'root',
				'DB_PORT_3306_TCP_PROTO' => 'tcp',
				'USERDB_DB_1_ENV_MARIADB_VERSION' => '1:10.1.48+maria-1~bionic',
			],
	...
	public function createService__61_App_RouterFactory(): App\RouterFactory
	{
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_fab266668e $container)
			{
	...
	{
		$service = $this->getService('61_App_RouterFactory')->createRouter('/userdb');
		return $service;
	}
